...
export default function MyCard({ card }) {
  ...
  function removeCard(cardId) {
    ...
    fetch(
      `https://api.shipap.co.il/business/cards/${cardId}?token=d215263e-78c2-11ee-8f3c-14dda9d4a5f0`,
      {
        credentials: "include",
        method: "DELETE",
  ...
  function favoriteCard(cardId) {
    ...
    fetch(
      `https://api.shipap.co.il/cards/${cardId}/favorite?token=d215263e-78c2-11ee-8f3c-14dda9d4a5f0`,
      {
        credentials: "include",
        method: "PUT",
      }
  ...
  function undoFavoriteCard(cardId) {
    ...
    if (!confirmQuestion) return;
    fetch(
      `https://api.shipap.co.il/cards/${cardId}/unfavorite?token=d215263e-78c2-11ee-8f3c-14dda9d4a5f0`,
      {
        credentials: "include",
        method: "PUT",
      }
